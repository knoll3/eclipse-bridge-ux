        ...
        <div>
          <div className="network-section">
            ...
            <NetworkBox
              ...
              onClickEvent={() =>
                evmWallet && handleUnlinkWallet(evmWallet.id) && setIsEvmDisconnected(!isEvmDisconnected)
              }
              walletChain="EVM"
            ...
            <NetworkBox
              ...
              onClickEvent={() =>
                solWallet && handleUnlinkWallet(solWallet.id) && setIsSolDisconnected(!isSolDisconnected)
              }
              walletChain="SOL"
          ...
          <div className={`amount-input flex flex-col ${determineInputClass()}`}>
            ...
            >
              ...
              <div className={evmWallet ? "percentage-buttons" : "invisible"}>
                <button onClick={() => setAmountEther(balanceEther * 0.25)} className="percentage-button">
                  25%
                </button>
                <button onClick={() => setAmountEther(balanceEther * 0.5)} className="percentage-button">
                  50%
                </button>
                <button onClick={() => setAmountEther(balanceEther)} className="percentage-button">
                  Max
                </button>
              </div>
            </div>
